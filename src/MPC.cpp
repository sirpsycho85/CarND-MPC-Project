...
vector<double> MPC::Solve(Eigen::VectorXd x0, Eigen::VectorXd coeffs) {
  ...
  // variable bounds
  // Non-actuators are set to min/max values e19
  // Actuators are set to +/-25 degrees for steer and +/-1 for throttle
  ...
  //FUTURE: why are some constraints in fg_eval and some in vars_. Also what are constraints_?
